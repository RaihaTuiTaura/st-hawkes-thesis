...
#PBS -j oe
#PBS -V
#PBS -o index_value_sthawkes_alpha_unres_stdout.out
#PBS -e index_value_sthawkes_alpha_unres_stderr.out
...
run_program(){
    ...
    cd $PBS_O_WORKDIR
    Rscript test_discretetime_st_stan_hpc_alpha_unres.R index_value
